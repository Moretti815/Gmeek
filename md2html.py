    ...
    def _add_controls(self, html: str) -> str:
        ...
        def _repl(m):
            ...
            controls = (
                ...
                '<button class="fold-btn" title="折叠/展开">▲</button>'
                '<button class="copy-btn" title="复制代码">'
                '<svg width="18" height="18" viewBox="0 0 20 20" style="vertical-align:middle">'
                '<rect x="6" y="2" width="9" height="13" rx="2" fill="currentColor"/>'
                '<rect x="3" y="5" width="9" height="13" rx="2" fill="currentColor" opacity="0.6"/>'
                '</svg>'
                '</button>'
                '</div>'
            )
